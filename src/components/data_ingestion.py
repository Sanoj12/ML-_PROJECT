...
if __name__=="__main__":
     ...
     test_arr, train_arr ,preprocessing_path= data_transform.initiate_data_transformation(train_set,test_set)  
     

     model_trainer = ModelTrainer()
     print(model_trainer.initiate_model_trainer(test_arr,train_arr))
